...
export const capabilities: Domain[] = [
  ...
  },
  {
    ...
    tag: 'Integration',
    problem: 'Best-in-class tools operating in functional isolation — preventing the organization from functioning as a unified system.',
  ...
  },
  {
    ...
    tag: 'Transformation',
    problem: 'Organizations aware of the need to transform but without the strategic clarity and implementation capacity to do so safely.',
...
export const outcomes: Outcome[] = [
  {
    industry: 'Professional Services Firm · 200 Staff',
    tag: 'Reporting Time',
    stat: '68%',
    statSub: 'reduction in manual reporting time',
    story: 'By unifying project management, time tracking, and billing into a single operational system, a regional consulting firm eliminated manual assembly of weekly performance reports — reclaiming twelve hours of senior staff time per week.',
    paletteIndex: 0,
  },
  {
    ...
    story: 'A boutique investment firm running client onboarding across five disconnected platforms. KEYOB designed and activated a unified onboarding architecture — compressing a fourteen-day process into under five, without expanding the compliance team.',
    paletteIndex: 1,
  },
  {
    industry: 'BestValue Autoparts · Automotive Distribution',
    tag: 'Inventory Visibility',
    stat: 'Real-time',
    statSub: 'stock visibility across 12 warehouses',
    story: 'A national parts distributor managing inventory across twelve warehouses through nightly batch updates. KEYOB built the integration and reporting layer for real-time stock, transfer, and demand visibility — eliminating $4M in overstock within one quarter.',
    paletteIndex: 2,
  },
  {
    industry: 'Australian Unity · Member Services',
    tag: 'Service Capacity',
    stat: '42%',
    statSub: 'increase in member servicing capacity',
    story: 'Member services operating across disconnected CRM, claims, and communication systems with significant manual handoff. KEYOB designed the unified member operating layer — reducing average handle time by 38% and lifting first-contact resolution by 24%.',
    paletteIndex: 3,
  },
  {
    industry: 'Financial Services · Advisory Network',
    tag: 'Systems Consolidation',
    stat: '4→1',
    statSub: 'systems consolidated into unified CRM',
    story: 'A wealth management network operating client data across four disconnected platforms. KEYOB designed and activated a single integrated CRM — giving advisors complete client visibility for the first time and reducing client onboarding time by 40%.',
    paletteIndex: 4,
  },
  {
    industry: 'TCI Coaching Institute · Education',
    tag: 'Admin Automation',
    stat: '60%',
    statSub: 'reduction in administrative time',
    story: 'A national coaching institute manually managing enrolment, scheduling, billing, and student communication across spreadsheets. KEYOB delivered a single operational platform — letting faculty focus on teaching, not data entry, across eighteen centres.',
    paletteIndex: 5,
  },
  {
    industry: 'Esteem Construction · Construction',
    tag: 'Project Visibility',
    stat: '11→1',
    statSub: 'tools consolidated into project hub',
    story: 'A mid-tier construction company running eleven tools across project management, RFIs, procurement, and reporting. KEYOB designed and built a single project operations hub — recovering an estimated 1,400 hours of project manager time per quarter.',
    paletteIndex: 6,
  },
  {
    industry: 'Healthcare Network · Multi-Site',
    tag: 'Operational Visibility',
    stat: 'Real-time',
    statSub: 'visibility — previously weekly',
    story: 'A regional health network making capacity and staffing decisions on weekly manually-assembled reports. KEYOB built a real-time operational dashboard connecting appointment, clinical, and administrative data — transforming decision-making speed across six sites.',
    paletteIndex: 3,
  },
];
